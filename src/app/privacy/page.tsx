export default function PrivacyPolicyPage() {
  return (
    <div className="container py-8 prose dark:prose-invert max-w-none">
      ...
      <h2>Introduction</h2>
      <p>
        Welcome to Hyper Recipe. We respect your privacy and are committed to
      ...
      <ul>
        <li>
          ...
          collect your email address and authentication information.
        </li>
        <li>
        ...
        <li>
          ...
          website, including recipes viewed, saved, and created.
        </li>
        <li>
          ...
          versions, and operating system and platform.
        </li>
      </ul>
